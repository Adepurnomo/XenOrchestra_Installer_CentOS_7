...
sudo su -
echo "${kuning}Min spec for cluster, backup, continues"
echo "${kuning}replication (DC-DR),load balancing etc,"
echo "${kuning}for XenServer/CitrixHyprrvisor/XCP-NG  "
echo "${kuning}Like XCP, use guest tools from citrix xen"
echo "${kuning}4vCPU, 16GB RAM, NIC 10G or Bounded"
echo "${kuning}###########################################"
